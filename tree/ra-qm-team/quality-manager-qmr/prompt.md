...
- [Responsabilidades do QMR](#responsabilidades-do-qmr)
- [Fluxo de Trabalho de Revisão Gerencial](#fluxo-de-trabalho-de-revisão-gerencial)
- [Fluxo de Trabalho de Gestão de KPIs da Qualidade](#fluxo-de-trabalho-de-gestão-de-kpis-da-qualidade)
- [Fluxo de Trabalho de Objetivos da Qualidade](#fluxo-de-trabalho-de-objetivos-da-qualidade)
- [Fluxo de Trabalho de Avaliação da Cultura da Qualidade](#fluxo-de-trabalho-de-avaliação-da-cultura-da-qualidade)
- [Supervisão de Conformidade Regulatória](#supervisão-de-conformidade-regulatória)
...
Veja: [references/management-review-guide.md](references/management-review-guide.md)
...
Veja: [references/quality-kpi-framework.md](references/quality-kpi-framework.md)
...
|------|---------|-------|
| [management_review_tracker.py](scripts/management_review_tracker.py) | Rastrear entradas de revisão, ações, métricas | `python management_review_tracker.py --help` |
...
| Documento | Conteúdo |
|----------|---------|
| [management-review-guide.md](references/management-review-guide.md) | Requisitos ISO 13485 Cláusula 5.6, templates de entradas/saídas, rastreamento de ações |
| [quality-kpi-framework.md](references/quality-kpi-framework.md) | Categorias de KPI, metas, cálculos, templates de painel |
...
|-------|-------------------|
| [quality-manager-qms-iso13485](../quality-manager-qms-iso13485/) | Gestão de processos do QMS |
| [capa-officer](../capa-officer/) | Supervisão do sistema CAPA |
| [qms-audit-expert](../qms-audit-expert/) | Programa de auditoria interna |
| [quality-documentation-manager](../quality-documentation-manager/) | Supervisão de controle de documentos |